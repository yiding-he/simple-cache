...
public class CaffeineSimpleCacheTest {
    ...
    public void testMultipleSimpleCache() throws Exception {
        SimpleCache simpleCache1 = new SimpleCache(new CaffeineConfiguration());
        SimpleCache simpleCache2 = new SimpleCache(new CaffeineConfiguration());
        SimpleCache simpleCache3 = new SimpleCache(new CaffeineConfiguration());

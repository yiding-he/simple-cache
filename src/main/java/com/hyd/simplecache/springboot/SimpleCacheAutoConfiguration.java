...
public class SimpleCacheAutoConfiguration {
    ...
    private Map<String, RedisConfiguration> redis = new HashMap<String, RedisConfiguration>();

    private Map<String, MemcachedConfiguration> memcached = new HashMap<String, MemcachedConfiguration>();
